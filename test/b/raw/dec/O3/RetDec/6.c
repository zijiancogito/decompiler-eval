...
int64_t _start(int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6) {
    // 0x1060
    int64_t v1; // 0x1060
    __libc_start_main(0x1450, (int32_t)a6, (char **)&v1, NULL, NULL, (void (*)())a3);
    __asm_hlt();
    // UNREACHABLE
}
...
// Address range: 0x14f0 - 0x150f
int64_t f_rand_4(void) {
    uint32_t result = rand(); // 0x14f1
    printf("f_rand_4: %d", 4);
    return result;
}
