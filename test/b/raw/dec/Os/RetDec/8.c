...
// Address range: 0x12da - 0x12f6
int64_t f_rand_0(int64_t a1, int64_t a2) {
    uint32_t result = rand(); // 0x12db
    printf("f_rand_0: %d", 0);
    return result;
}

// Address range: 0x12f6 - 0x1315
int64_t f_rand_1(void) {
    uint32_t result = rand(); // 0x12f7
    printf("f_rand_1: %d", 1);
    return result;
}

// Address range: 0x1315 - 0x1334
int64_t f_rand_2(void) {
    uint32_t result = rand(); // 0x1316
    printf("f_rand_2: %d", 2);
    return result;
}

// Address range: 0x1334 - 0x1353
int64_t f_rand_3(void) {
    uint32_t result = rand(); // 0x1335
    printf("f_rand_3: %d", 3);
    return result;
}

// Address range: 0x1353 - 0x1372
int64_t f_rand_4(void) {
    uint32_t result = rand(); // 0x1354
    printf("f_rand_4: %d", 4);
    return result;
}
