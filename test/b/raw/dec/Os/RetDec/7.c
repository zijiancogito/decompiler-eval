...
int64_t _start(int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6) {
    // 0x1060
    int64_t v1; // 0x1060
    __libc_start_main(0x1307, (int32_t)a6, (char **)&v1, NULL, NULL, (void (*)())a3);
    __asm_hlt();
    // UNREACHABLE
}
...
// Address range: 0x135f - 0x137e
int64_t f_rand_2(void) {
    uint32_t result = rand(); // 0x1360
    printf("f_rand_2: %d", 2);
    return result;
}

// Address range: 0x137e - 0x139d
int64_t f_rand_3(void) {
    uint32_t result = rand(); // 0x137f
    printf("f_rand_3: %d", 3);
    return result;
}

// Address range: 0x139d - 0x13bc
int64_t f_rand_4(void) {
    uint32_t result = rand(); // 0x139e
    printf("f_rand_4: %d", 4);
    return result;
}

// Address range: 0x13bc - 0x13c9
int64_t _fini(void) {
    // 0x13bc
    int64_t result; // 0x13bc
    return result;
}
