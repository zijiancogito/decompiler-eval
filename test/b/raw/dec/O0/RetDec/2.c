...
// Address range: 0x1340 - 0x136c
int64_t f_rand_3(void) {
    uint32_t result = rand(); // 0x1348
    printf("f_rand_3: %d", 3);
    return result;
}

// Address range: 0x1370 - 0x139c
int64_t f_rand_4(void) {
    uint32_t result = rand(); // 0x1378
    printf("f_rand_4: %d", 4);
    return result;
}
