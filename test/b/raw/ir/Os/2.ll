...
define dso_local i32 @func0() local_unnamed_addr #0 {
  ...
  %3 = tail call i32 @f_rand_4() #3
  %4 = tail call i32 @f_rand_0() #3
...
10:                                               ; preds = %0, %10
  ...
  br i1 %9, label %10, label %12, !llvm.loop !5

12:                                               ; preds = %10
  %13 = sub i32 %1, %2
  %14 = add nsw i32 %13, %5
  %15 = xor i32 %14, 966
  %16 = add nsw i32 %15, 966
  %17 = and i32 %16, %8
  %18 = srem i32 %17, %1
  %19 = mul nsw i32 %18, %1
  %20 = or i32 %19, %1
  %21 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 2) #3
  %22 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 3) #3
  %23 = xor i32 %20, %2
  ret i32 %23
}
