...
12:                                               ; preds = %0
  ...
  %15 = add nsw i32 %14, %5
  %16 = xor i32 %15, 966
  %17 = add nsw i32 %16, 966
  %18 = and i32 %17, %8
  %19 = srem i32 %18, %1
  %20 = mul nsw i32 %19, %1
  %21 = or i32 %20, %1
  %22 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 2)
  %23 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 3)
  %24 = xor i32 %21, %2
  ret i32 %24
}
