...
66:                                               ; preds = %0
  %67 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 8)
  %68 = icmp sgt i32 %1, %2
  br i1 %68, label %77, label %69

69:                                               ; preds = %66
  %70 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 9)
  %71 = xor i32 %9, -1
  %72 = sub nsw i32 %2, %71
  %73 = and i32 %72, %1
  %74 = xor i32 %73, -1
...
77:                                               ; preds = %66
  %78 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 10)
  %79 = xor i32 %1, -1
  %80 = xor i32 %5, %1
  %81 = srem i32 %80, %79
  br label %82
...
82:                                               ; preds = %77, %69
  ...
  %86 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 11)
...
89:                                               ; preds = %59, %82
  ...
  %93 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 12)
  %94 = sub nsw i32 0, %92
  %95 = or i32 %94, 1
  %96 = sub nsw i32 %95, %91
  %97 = srem i32 %96, %91
  %98 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 13)
