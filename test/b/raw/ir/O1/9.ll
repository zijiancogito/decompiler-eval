...
18:                                               ; preds = %12, %18
  %19 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 2)
...
28:                                               ; preds = %20, %12
  ...
  %32 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 3)
  %33 = sdiv i32 %2, %29
  %34 = sdiv i32 %33, %30
  br i1 %9, label %35, label %41

35:                                               ; preds = %28
  %36 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 4)
  %37 = xor i32 %30, %2
  %38 = sdiv i32 %37, %11
...
41:                                               ; preds = %35, %28
  ...
  br i1 %45, label %12, label %46, !llvm.loop !8
...
54:                                               ; preds = %46
  %55 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 6)
  %56 = xor i32 %49, %2
  %57 = srem i32 %56, %48
  %58 = mul i32 %49, %57
  %59 = sub i32 0, %58
...
63:                                               ; preds = %54
  %64 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 7)
  %65 = add i32 %51, %47
  %66 = add i32 %65, %49
  br label %67
...
67:                                               ; preds = %63, %54
  ...
  %69 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 8)
  %70 = icmp sgt i32 %61, %47
  %71 = select i1 %70, i32 9, i32 10
  %72 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef %71)
  %73 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 11)
  br label %74

74:                                               ; preds = %67, %46
  %75 = phi i32 [ %68, %67 ], [ %48, %46 ]
  %76 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 12)
  %77 = sdiv i32 %75, %49
  ret i32 %77
}
