...
8:                                                ; preds = %0
  %9 = add nsw i32 %3, 895
  %10 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 1)
  %11 = mul i32 %3, %3
  %12 = mul i32 %11, %9
  %13 = sub nsw i32 %12, %1
  %14 = mul nsw i32 %13, %1
...
15:                                               ; preds = %0
  %16 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 3)
  %17 = icmp sgt i32 %1, 555
  br i1 %17, label %18, label %21

18:                                               ; preds = %15, %18
  %19 = phi i1 [ %17, %18 ], [ true, %15 ]
  %20 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 4)
  br i1 %19, label %18, label %21, !llvm.loop !5

21:                                               ; preds = %18, %15
  %22 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 5)
  %23 = icmp slt i32 %2, %3
...
26:                                               ; preds = %24, %26
  %27 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 6)
  br i1 %25, label %26, label %28, !llvm.loop !8

28:                                               ; preds = %26, %21
  %29 = phi i32 [ %3, %21 ], [ 0, %26 ]
  %30 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 7)
  %31 = icmp sgt i32 %29, 853
  %32 = select i1 %31, i32 8, i32 9
  %33 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef %32)
  %34 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 10)
  br label %35

35:                                               ; preds = %28, %8
  %36 = phi i32 [ %14, %8 ], [ %29, %28 ]
  %37 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 11)
  %38 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 12)
  %39 = or i32 %36, %1
  ret i32 %39
}
