...
23:                                               ; preds = %17, %0
  ...
  %25 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 5)
...
29:                                               ; preds = %27, %29
  ...
  %32 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 10)
  br label %29
...
37:                                               ; preds = %23
  %38 = and i32 %10, %2
  %39 = tail call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 noundef 11)
  %40 = add nsw i32 %3, -719
  %41 = xor i32 %4, %40
  %42 = and i32 %41, %5
  %43 = srem i32 %42, %38
  ret i32 %43
