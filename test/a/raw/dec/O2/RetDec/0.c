...
int64_t _start(int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6) {
    // 0x1060
    int64_t v1; // 0x1060
    __libc_start_main(0x12c0, (int32_t)a6, (char **)&v1, NULL, NULL, (void (*)())a3);
    __asm_hlt();
    // UNREACHABLE
}
...
// Address range: 0x1150 - 0x12b1
int64_t func0(int64_t a1, int64_t a2) {
    int64_t v1 = f_rand_3(); // 0x115b
    int64_t v2 = f_rand_2(); // 0x1163
    int64_t v3 = f_rand_1(); // 0x116c
    int64_t v4 = v3 & 0xffffffff; // 0x1171
    int64_t v5 = f_rand_4(); // 0x1174
    int64_t v6 = f_rand_0(a1, a2); // 0x117c
    printf("BB: %d", 0);
    int64_t v7 = (v6 | 777) & v5; // 0x11a3
    int64_t v8 = (v7 + 0xfffffc2a ^ v1) & 0xffffffff;
    int64_t v9 = v6 & 0xffffffff;
    printf("BB: %d", 1);
    uint32_t v10 = (int32_t)v6; // 0x11ee
    int64_t v11; // 0x1150
    int64_t v12; // 0x1150
    int64_t v13; // 0x1150
    int64_t v14; // 0x1202
    ...
    while ((int32_t)v2 <= 817) {
        int64_t v15 = v12;
        printf("BB: %d", 6);
        int64_t v16 = v9; // 0x1256
        if (v10 <= 222) {
            int64_t v17 = v15 & (v5 ^ 0xffffffff); // 0x125f
            printf("BB: %d", 7);
        ...
        // 0x11c0
        printf("BB: %d", 8);
        int64_t v18 = v15 + (v1 & 0xffffffff); // 0x11cf
        int64_t v19 = (0x100000000 * (int64_t)((int32_t)v18 >> 31) | v18 & 0xffffffff) / (v11 & 0xffffffff); // 0x11d4
        int64_t v20 = (0x100000000 * (int64_t)((int32_t)v19 >> 31) | v19 & 0xffffffff) / v16; // 0x11da
        int64_t v21 = v11; // 0x11da
        v8 = v15;
        v9 = v20 & 0xffffffff;
        printf("BB: %d", 1);
        v10 = (int32_t)v20;
...
// Address range: 0x12d0 - 0x12ec
int64_t f_rand_0(int64_t a1, int64_t a2) {
    uint32_t result = rand(); // 0x12d1
    printf("f_rand_0: %d", 0);
    return result;
}

// Address range: 0x12f0 - 0x130f
int64_t f_rand_1(void) {
    uint32_t result = rand(); // 0x12f1
    printf("f_rand_1: %d", 1);
    return result;
}

// Address range: 0x1310 - 0x132f
int64_t f_rand_2(void) {
