...

{
  ...
  uVar7 = (ulong)uVar5;
  printf("BB: %d",0);
  uVar8 = (uVar5 | 0x309) & uVar4;
  uVar5 = uVar8 - 0x3d6 ^ uVar1;
  while( true ) {
    printf("BB: %d",1);
    uVar6 = (uint)uVar7;
    if (uVar3 == uVar6) {
      printf("BB: %d",3);
      uVar9 = ~uVar5;
      uVar5 = (int)uVar9 / (int)uVar3;
      uVar7 = (long)(int)uVar9 % (long)(int)uVar3;
    }
    else {
      printf("BB: %d",2);
      uVar8 = (int)(uVar1 & uVar6) / (int)uVar5;
      uVar7 = (long)(int)(uVar1 & uVar6) % (long)(int)uVar5;
    }
    ...
    printf("BB: %d",8);
    uVar7 = (long)(int)(uVar1 + uVar5) / (long)(int)uVar8;
