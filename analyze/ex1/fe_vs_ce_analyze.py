...
def relation(p1, r1, p2, r2, save_to):
    ...
    from my_math import average_x_y, plot_base
    # Average
    x, y = average_x_y(p1, p2)
    plot_base(x, y, os.path.join(save_to, 'avg_p_fea_dec.jpg'))

    x, y = average_x_y(r1, r2)
    plot_base(x, y, os.path.join(save_to, 'avg_r_fea_dec.jpg'))
